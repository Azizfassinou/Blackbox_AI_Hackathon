...
class CommentFormatter:
    ...
    def format_multiple_issues(self, issues: List[Dict[str, Any]], filename: str) -> str:
        """
...
"""
    ...
    def format_request_changes_comment(self, critical_issues: List[Dict[str, Any]]) -> str:
        """Format a request changes comment."""
        comment = "## ⚠️ Changes Requested by Blackbox AI\n\n"
        comment += "Critical issues were found that should be addressed before merging.\n\n"
    ...
    def truncate_comment(self, comment: str, max_length: int = 65536) -> str:
        ...
        truncated += "\n\n---\n\n"
        truncated += "*⚠️ Comment truncated due to length. See full analysis in artifacts.*\n"
