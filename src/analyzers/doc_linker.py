...
class DocLinker:
    ...
    def find_relevant_docs(self, code_or_message: str, filename: str = "") -> List[Dict[str, str]]:
        """
    ...
    def suggest_docs_for_issue(self, issue_type: str, message: str) -> List[Dict[str, str]]:
        """
